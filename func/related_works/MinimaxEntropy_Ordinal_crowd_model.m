...
[verbose, maxIter, TOL, prior_workers,  prior_tasks] = process_varargin(varargin,'verbose', 1, 'maxIter', 10, 'TOL', 1e-3, {'prior_worker', 'ell'}, [], 'prior_task', []);
...
[maxIter_Mstep, optTOL_Mstep, progTOL_Mstep] = process_varargin(varargin, 'maxIter_Mstep', 10, 'optTOL_Mstep', 1e-5, 'progTOL_Mstep', 1e-9);
